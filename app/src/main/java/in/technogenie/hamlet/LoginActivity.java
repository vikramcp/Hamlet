...
public class LoginActivity extends AppCompatActivity implements  LoaderCallbacks<Cursor>, View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Login Using Facebook API START
         */
        ...
        /**
         * Login Using Facebook API END
         */

        /**
         * Login Using Google API START
         */
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            try {
                ...
                jsonObject.put("gPicture", personPhotoUrl);
...
/*            txtName.setText(personName);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        // be available.
        Log.d(LoginActivity.class.getSimpleName(), "onConnectionFailed:" + connectionResult);
    }
