...
public class SlideShowFragment extends DialogFragment implements GalleryStripAdapter.GalleryStripCallBacks {
    ...
    public static SlideShowFragment newInstance(int position, ArrayList<GalleryItemVO> galleryItems) {
        ...
        args.putSerializable("galleryItems", galleryItems);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            galleryItems = (ArrayList) getArguments().getSerializable("galleryItems");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.gallery_fragment_silde_show, container, false);
